...
aiinaalpkg="Lumina-T2X"
aiinaalpkgURL="http://github.com/Alpha-VLLM/Lumina-T2X.git"
...
echo "python $AIROCmALdir/$aiinaalpkg/lumina_t2i/demo.py" >> $AIROCmALdir/$aiinaalpkg/$aiinaalpkg-Start.sh
#echo "sleep 60"
...
echo "Installation complete. Start with command: AIROCmAL-$aiinaalpkg with any Lumina-T2X arguments afterward"
