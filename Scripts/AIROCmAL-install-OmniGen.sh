...
echo "python $AIROCmALdir/$aiinaalpkg/app.py \"\$@\"" >> $AIROCmALdir/$aiinaalpkg/$aiinaalpkg-Start.sh
echo "sleep 5"
...
echo "Installation complete. Start with command: AIROCmAL-$aiinaalpkg with any OmniGen arguments afterward"
