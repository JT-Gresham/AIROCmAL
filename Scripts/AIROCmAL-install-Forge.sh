...
aiinaalpkg="Forge"
aiinaalpkgURL="https://github.com/lllyasviel/stable-diffusion-webui-forge.git"
...
echo "python $AIROCmALdir/$aiinaalpkg/launch.py --port 7866 --use-ipex \"\$@\"" >> $AIROCmALdir/$aiinaalpkg/$aiinaalpkg-Start.sh
echo "sleep 60"
...
echo "Installation complete. Start with command: AIROCmAL-$aiinaalpkg with any Forge arguments afterward"
