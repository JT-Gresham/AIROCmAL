...
cp $AIROCmALdir/$aiinaalpkg/user_customize_$aiinaalpkg"_example.sh" $AIROCmALdir/$aiinaalpkg/user_customize_$aiinaalpkg.sh
#echo ""
...
echo "python $AIROCmALdir/$aiinaalpkg/run.py" >> $AIROCmALdir/$aiinaalpkg/$aiinaalpkg-Start.sh
#echo "sleep 60"
...
echo "Installation complete. Start with command: AIROCmAL-$aiinaalpkg with any RoopUL arguments afterward"
