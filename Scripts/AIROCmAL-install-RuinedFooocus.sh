...
aiinaalpkgURL="https://github.com/runew0lf//$aiinaalpkg.git"
...
echo "python $AIROCmALdir/$aiinaalpkg/launch.py --port 7865 \"\$@\"" >> $AIROCmALdir/$aiinaalpkg/$aiinaalpkg-Start.sh
echo "sleep 60"
#echo "echo "RuinedFooocus is still running in the background. Enter command: RuinedFooocus-exit to close down RuinedFooocus.""
#echo "" >> $AIROCmALdir/$aiinaalpkg/$aiinaalpkg-Start.sh
...
echo "Installation complete. Start with command: AIROCmAL-$aiinaalpkg with any RuinedFooocus arguments afterward"
