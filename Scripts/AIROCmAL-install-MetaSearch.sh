...
aiinaalpkg="MetaSearch"
aiinaalpkgURL="https://github.com/JT-Gresham//$aiinaalpkg.git"
...
echo "sleep 60"
#echo "echo "MetaSearch is still running in the background. Enter command: MetaSearch-exit to close down MetaSearch.""
#echo "" >> $AIROCmALdir/$aiinaalpkg/$aiinaalpkg-Start.sh
...
echo "Installation complete. Start with command: AIROCmAL-$aiinaalpkg with any MetaSearch arguments afterward"
