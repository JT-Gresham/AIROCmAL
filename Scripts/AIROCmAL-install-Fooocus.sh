...
aiinaalpkg="Fooocus"
aiinaalpkgURL="https://github.com/lllyasviel//$aiinaalpkg.git"
...
echo "Installation complete. Start with command: AIROCmAL-$aiinaalpkg with any fooocus arguments afterward"
