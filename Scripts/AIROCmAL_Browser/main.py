...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        home_btn = QAction("AIROCmAL", self)
        home_btn.setStatusTip("AIROCmAL Home")
        ...
        self.setWindowTitle("AIROCmAL Browser")
    ...
    def add_new_tab(self, qurl=None, label="NEW", text="New Tab"):
        ...
        if qurl is None:
            ...
            qurl = QUrl("http://github.com/JT-Gresham/AIROCmAL")
    ...
    def navigate_home(self):
        ...
        # go to google
        self.tabs.currentWidget().setUrl(QUrl("http://github.com/JT-Gresham/AIROCmAL"))
...
app.setApplicationName("AIROCmAL Browser")
