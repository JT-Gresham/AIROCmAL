...
tar -xvf $tgzpkgname
echo ""
echo "Copying Ollama executable to AIROCmAL environment..."
cp ./bin/ollama $AIROCmALdir/AIROCmAL_env/bin/
echo "Copying library files to AIROCmAL environment..."
cp -Rf ./lib/ollama $AIROCmALdir/AIROCmAL_env/lib/python3.11/site-packages/
...
echo "ollama serve &" >> $AIROCmALdir/$aiinaalpkg/$aiinaalpkg-Start.sh
