...
aiinaalpkgURL="https://github.com/index-tts/index-tts.git"
...
cp "$AIROCmALdir/$aiinaalpkg/checkpoints/config.yaml" "$AIROCmALdir/shared/checkpoints/tts/config.yaml"
...
echo "python $AIROCmALdir/$aiinaalpkg/webui.py \"\$@\"" >> $AIROCmALdir/$aiinaalpkg/$aiinaalpkg-Start.sh
#echo "sleep 60"
...
echo "Installation complete. Start with command: AIROCmAL-$aiinaalpkg with any Index-TTS arguments afterward"
