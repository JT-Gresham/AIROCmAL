...
aiinaalpkg="Auto1111"
aiinaalpkgURL="https://github.com/AUTOMATIC1111//stable-diffusion-webui.git"
...
echo "python $AIROCmALdir/$aiinaalpkg/launch.py --use-ipex --port 7865 \"\$@\"" >> $AIROCmALdir/$aiinaalpkg/$aiinaalpkg-Start.sh
echo "sleep 60"
...
echo "Installation complete. Start with command: AIROCmAL-$aiinaalpkg with any Auto1111 arguments afterward"
